...
1. Get updated numbers (# unique individuals egno, # unique code with age sex class #in each class)-- Christin can pull from table or do it in R

2. Install newer version of SOCPROG

3. Make tables needed (primary and supple)

4. Run social differentiation SOCPROG
...
1. Make plots of different overlap day thresholds for juveniles and lactating females to help us decide but leaning towards just using one day as overlap criteria

2. Play with the R code for measuring the complexity of social associations using mixture models (Weiss paper) and think about that

3. Once overlap criteria is sorted out, export the matrix for the permutation tests in SOCPROG
