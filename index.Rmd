...
Things for us to discuss today:

1. What about switching our default day to work on this to Thursdays?
2. Discuss overlap criteria
3. Discuss social differentiation R code
4. Discuss use of Simple ratio and write up about it's justification
5. Get updated numbers (# unique individuals egno, # unique code with age sex class #in each class)
